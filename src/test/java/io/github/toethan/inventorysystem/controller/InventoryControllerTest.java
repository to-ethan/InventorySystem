...
public class InventoryControllerTest {
    ...
    void getRequestForAll() throws Exception {
        ...
        this.mockMvc.perform(request)
            ...
            .andExpect(content().contentType(
                    new MediaType(MediaType.TEXT_HTML.getType(),
    ...
    */
    ...
    void postRequestForNew() throws Exception {
        ...
        RequestBuilder request = post("/inventory/new")
                .param("name", "test");
    ...
    void updateInventoryPostRequest() throws Exception {
        Inventory expectedInventory = new Inventory(null, "test", Arrays.asList());
        when(inventoryServiceMock.all()).thenReturn(Arrays.asList(expectedInventory, expectedInventory, expectedInventory));
